...
public class Menu {
	...
	public void menuVisual() {
		...
		System.out.println("3-Listar todo dinheiro");
		System.out.println("4-Calcular total de dinheiro convertido para Real");
	...
	public void menuEscolha() {
		System.out.println("Escolha o tipo de Dinheiro:");
	...
	public void menuOpcoes() {
		 ...
		 * por criar métodos para não deixar um código todo emaranhado*/
			...
			System.out.println("Aqui esta o seu dinheiro: ");
			c.listagemMoedas();
			menuOpcoes();
		//recursão para o método executar novamente
		}else if(opcao==4) {
			double dinheiroConvertido = c.totalConvertido();	
			System.out.println(String.format("O dinheiro total convertido para real e: %.2f",dinheiroConvertido));
			menuOpcoes();
		}else if(opcao==0){
			return;
